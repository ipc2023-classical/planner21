...
PDDL_BENCHMARK_DIR = "/proj/dfsplan/ragnarok/pddl"
...
SUITE_TEST = [
    ...
    "nomystery-strips",
    "openstacks-strips",
    "organic-synthesis-strips",
    "organic-synthesis-split-strips",
    "parcprinter-strips",
    "parking-strips",
    "parking-strips",
    "pathways-strips",
    "pegsol-strips",
    "pegsol-strips",
    "petri-net-alignment-strips",
    "pipesworld-notankage-strips",
    "pipesworld-tankage-strips",
    "psr-small-strips",
    "rovers-strips",
    "satellite-strips",
    "scanalyzer-strips",
